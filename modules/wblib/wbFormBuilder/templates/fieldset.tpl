  <fieldset class="fbouter" id="fbform-{{ formname }}">
    ...
    {{ :if req_info }}<br style="clear: both;" /><div class="fbicon{{ :if req_class }} {{ req_class }}{{ :ifend }}"><span style="color:red;font-weight:bold;font-size:1.3em;margin-right:15px;">{{ req }}</span>{{ req_info }}</div>{{ :ifend }}
    {{ form }}
    <br style="clear: left;" />
    {{ :if buttons }}
