...
$query_category = $database->query("SELECT * FROM ".TABLE_PREFIX."mod_faq_categories WHERE cat_id='$category_id'");
...
<form name="modify" action="<?php echo WB_URL; ?>/modules/faqbaker/save_category.php" method="post" style="margin: 0;">
